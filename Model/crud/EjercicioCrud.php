...
class EjercicioCrud {
    ...
    // Actualizar estado de un ejercicio usando lenguaje, nivel y cédula
    ...
    private function obtenerSalidaEsperada($lenguaje, $numeroEjercicio) {
        $jsonPath = $this->root . DIRECTORY_SEPARATOR 
                  . "Controller" . DIRECTORY_SEPARATOR 
                  . "Ejercicio_cargados" . DIRECTORY_SEPARATOR 
                  . strtolower($lenguaje) . "-json" . DIRECTORY_SEPARATOR 
                  . "ejercicio_{$numeroEjercicio}.json";
    ...
    private function guardarArchivo($lenguaje, $numeroEjercicio, $archivo, $contenido) {
        $rutaBase = $this->root . DIRECTORY_SEPARATOR 
                  . "Controller" . DIRECTORY_SEPARATOR 
                  . "Ejercicio_cargados" . DIRECTORY_SEPARATOR 
                  . "entregas-" . strtolower($lenguaje) . DIRECTORY_SEPARATOR 
                  . "ejercicio_{$numeroEjercicio}" . DIRECTORY_SEPARATOR;
        if (!is_dir($rutaBase)) {
    ...
    private function obtenerComandoEjecutar($lenguaje, $rutaArchivo) {
        ...
        switch (strtolower($lenguaje)) {
            case "python":
                if ($os === 'WIN') {
                    // Usamos la ruta completa a python.exe para Windows
                    $rutaPython = "\"C:\\Users\\HP\\AppData\\Local\\Programs\\Python\\Python39\\python.exe\"";
                    return $rutaPython . " " . escapeshellarg($rutaArchivo);
                } else {
