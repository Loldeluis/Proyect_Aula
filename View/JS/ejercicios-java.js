document.addEventListener("DOMContentLoaded", () => {
 ...
 for (let i = inicio; i <= fin; i++) {
  console.log("Generando botón para nivel:", i); // <-- Agrega esto
  ...
  function cargarEjercicio(numero) {
     console.log("Número recibido:", numero); 
      const ruta = `http://localhost/Proyecto_Aula/Proyecto_Aula/Controller/Ejercicio_cargados/java-json/ejercicio_${numero}.json`;      
       fetch(ruta)
      .then((res) => {
